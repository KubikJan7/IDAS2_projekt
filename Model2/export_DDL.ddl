...
--   at:        2018-12-11 01:02:11 CET
--   site:      Oracle Database 12c
--   type:      Oracle Database 12c



DROP TABLE den CASCADE CONSTRAINTS;

DROP TABLE fakulta CASCADE CONSTRAINTS;

DROP TABLE forma_vyuky CASCADE CONSTRAINTS;

DROP TABLE kat_predmetu CASCADE CONSTRAINTS;

DROP TABLE katedra CASCADE CONSTRAINTS;

DROP TABLE obrazek CASCADE CONSTRAINTS;

DROP TABLE pred_plan CASCADE CONSTRAINTS;

DROP TABLE pred_v_planu CASCADE CONSTRAINTS;

DROP TABLE predmet CASCADE CONSTRAINTS;

DROP TABLE rel_uziv_role CASCADE CONSTRAINTS;
...
DROP TABLE stud_plan CASCADE CONSTRAINTS;

DROP TABLE tyden CASCADE CONSTRAINTS;

DROP TABLE tyden_akce CASCADE CONSTRAINTS;
